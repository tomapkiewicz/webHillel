...
class RecurrentPage(models.Model):
    ...
    con_mail_personalizado = BooleanField(verbose_name="Con mail personalizado", default=False)
    asunto_mail = models.CharField(verbose_name="Asunto del mail", max_length=200, null=True, blank=True)
    ...
    categories = models.ManyToManyField(Category, verbose_name='Categorias', related_name='get_recurrent_pages', blank=True)
